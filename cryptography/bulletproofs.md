...
### Bulletproofs-based mixing protocol[​](https://wiki.findora.org/docs/modules/cryptography/bulletproofs#bulletproofs-based-mixing-protocol) <a href="#bulletproofs-based-mixing-protocol" id="bulletproofs-based-mixing-protocol"></a>
...
* $$\mathsf{RHSMergeOrNot}(\overrightarrow{\mathsf{a\_amount}},\overrightarrow{\mathsf{a\_asset\_type}},\overrightarrow{\mathsf{b\_amount}},\overrightarrow{\mathsf{b\_asset\_type}})RHSMergeOrNot$$:
...
### Bulletproofs-based range check[​](https://wiki.findora.org/docs/modules/cryptography/bulletproofs#bulletproofs-based-range-check) <a href="#bulletproofs-based-range-check" id="bulletproofs-based-range-check"></a>

To prove that _a pair of_ Pedersen commitments are committing a valid amount in confidential payments, the Zei library makes use of Bulletproofs.

...
3. We will use a MetaMask account with an asset balance to deploy the contract. It can be funded through our testnet faucet ([refer to this guide](../../../../general-user-materials/acquire-fra/request-testnet-fra.md)) and then deployed on Findora Devnet.

...
1. Visit[ Findora Faucet](https://faucet.findora.org/) to receive FRC20 test tokens to your EVM Wallet. Add the FRC20 token via Import Tokens. \
...
### Prism++ Your FRC20 Tokens (EVM->Native)
...
4. Input your native wallet address (UTXO Wallet 1) and the amount.&#x20;

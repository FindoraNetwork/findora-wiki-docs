...
3\. On the Findora Wallet Tab, click the Prism++ tab and choose the direction from EVM wallet to Native wallet (UTXO Wallet 1). Then confirm your imported EVM wallet.
...
9\. Input your native wallet address (UTXO Wallet 1) and the amount. Then submit the transaction.
...
10\. On Send tab, perform the confidential transfer for the FRC20 token from UTXO Wallet 1 to UTXO Wallet 2.&#x20;
...
11\. Open the Manage Assets tab, and copy the FRC20’s asset code. Then click Add button
...
12\. Add the asset to your UTXO wallet 2

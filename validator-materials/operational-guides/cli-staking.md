...
You can request Testnet FRA tokens using our Discord Bot. Please [follow this guide](../../general-user-materials/acquire-fra/request-fra-testnet.md) to claim your free FRA Native Chain tokens.
